...
#
SET(CMAKE_FIND_LIBRARY_SUFFIXES ${CMAKE_FIND_LIBRARY_SUFFIXES} .so.3 .so.3gf)

SET(ATLAS_POSSIBLE_INCLUDE_PATHS
  ${CMAKE_SOURCE_DIR}/kaldi/tools/ATLAS_headers/include
  /usr/include
  /usr/include/atlas
  /usr/local/include
  $ENV{ATLAS_DIR}
...
# /usr/lib/libatlas.so.3 /usr/lib/libf77blas.so.3 /usr/lib/libcblas.so.3 /usr/lib/liblapack_atlas.so.3
FIND_LIBRARY(ATLAS_CBLAS_LIBRARY NAMES ptcblas_r ptcblas cblas_r cblas PATHS ${ATLAS_POSSIBLE_LIBRARY_PATHS} NO_DEFAULT_PATH)
FIND_LIBRARY(ATLAS_ATLAS_LIBRARY NAMES atlas_r atlas PATHS ${ATLAS_POSSIBLE_LIBRARY_PATHS} NO_DEFAULT_PATH)
FIND_LIBRARY(ATLAS_LAPACK_ATLAS_LIBRARY NAMES alapack_r alapack lapack_atlas lapack PATHS ${ATLAS_POSSIBLE_LIBRARY_PATHS} NO_DEFAULT_PATH)
FIND_LIBRARY(ATLAS_F77BLAS_LIBRARY NAMES f77blas_r f77blas PATHS ${ATLAS_POSSIBLE_LIBRARY_PATHS} NO_DEFAULT_PATH)
...
FOREACH(LIBNAME ATLAS_LAPACK_ATLAS_LIBRARY ATLAS_F77BLAS_LIBRARY ATLAS_CBLAS_LIBRARY ATLAS_ATLAS_LIBRARY)
  IF(${LIBNAME})
